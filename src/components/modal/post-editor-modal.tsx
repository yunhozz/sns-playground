...
import { usePostEditorModal } from "@/state/post-editor-modal-state.ts";
...
export default () => {
    ...
    const onClickSavePostButton = () => {
        if (!postEditorModal.isOpen || content.trim() === "") return;
    ...
    return (
        <Dialog open={postEditorModal.isOpen} onOpenChange={onOpenChangeDialog}>
